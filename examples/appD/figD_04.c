...
int main(void) {
   ...
   double complex difference = a - b; // perform complex addition
   printf("a - b is: %.1f + %.1fi\n", creal(difference), cimag(difference));

   double complex product = a * b; // perform complex addition
   printf("a * b is: %.1f + %.1fi\n", creal(product), cimag(product));

   double complex quotient = a / b; // perform complex addition
